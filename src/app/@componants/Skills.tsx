...
const Skills = () => {
  return (
    <div className="h-[100vh]">
      <h1 className=" text-[50px] text-white font-bold text-center"> Skills</h1>
      <div className="  flex items-center w-full " data-aos="zoom-out-down">
        <div className=" profile mt-10 sm:flex sm:justify-around sm:m-[15px] sm:items-center w-full  ">
          <div className="w-full mt-10 ">
            <div className=" flex  justify-center items-center gap-8">
              <div
                data-aos="zoom-out-right"
                className=" h-[280px] w-[120px] border-[2px] border-white rounded grid grid-rows-[1fr,2fr] items-center shadow-stone-300 shadow-md  "
              >
              ...
              <div
                ...
                className=" h-[280px] w-[110px] border-[2px] border-white rounded grid grid-rows-[1fr,2fr] shadow-stone-300 shadow-md"
              >
                <div>
                  {" "}
              ...
              >
                ...
                <div className=" bg-white text-black">
                  ...
                  <p className=" font-semibold text-[11px] text-center mt-2 ">
