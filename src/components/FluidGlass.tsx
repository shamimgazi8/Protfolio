...
function Images() {
  ...
  return (
    <group ref={group}>
      <Image position={[-2, 0, 0]} scale={[3, height / 1.1]} url="/1.png" />
      <Image position={[2, 0, 3]} scale={3} url="/ant.png" />
      <Image position={[-2.05, -height, 6]} scale={[1, 3]} url="/avater.jpg" />
      <Image position={[-0.6, -height, 9]} scale={[1, 2]} url="/avater2.jpg" />
      <Image position={[0.75, -height, 10.5]} scale={1.5} url="/figma.png" />
    </group>
  );
}
